<?php 
   // Template Name: Both Teams To Score & Win Tips
   get_header(); ?>
<div class="wrapper">
...
<div class="ui  stackable grid" id="content">
   ...
   <div class="ui ten wide column">
      <div class="content">
         <div class="title_h1">
            <h1>Both Teams To Score And Win Accumulator</h1>
         </div>
         ...
         <p></p>
         <div class="ui horizontal divider">Both Teams To Score and Win Accumulator</div>
         <!-- hello5-->
...
<!-- End -->
         ...
         <div class="fst segment">
             <?php $args = array( 'post_type' => 'tips','category_name'=>'both-teams-to-score-win-tips','posts_per_page' => 1 );
                    $loop = new WP_Query( $args );
                    while ( $loop->have_posts() ) : $loop->the_post();
          ?>  
          <h1><?php the_title();?></h1>
